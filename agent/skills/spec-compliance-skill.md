...
4. **Reporting**: Output the results in a table format:
   ...
   |---------|--------|----------------------|
   | [Name]  | [Pass/Fail] | [List of missing tags] |

## Rules for Response
- Be objective.
- If a function is compliant, mark it as "Verified."
- If incomplete, provide the exact JSDoc snippet that would bring it to compliance.
